...
import au.com.self.ide.vscode.ext.plantuml.NullSVGConverterController;
...
public class PdfConverter {
	...
	public static void convert(File svgFile, File pdfFile) {
		...
		try {
			SVGConverterController test = new NullSVGConverterController();
			SVGConverter cnv = new SVGConverter(test);
			cnv.setDestinationType(DestinationType.PDF);
...
/*			final Class<?> clSVGConverter = Class.forName("org.apache.batik.apps.rasterizer.SVGConverter");
			...
			clSVGConverter.getDeclaredConstructor(new Class[] {org.apache.batik.apps.rasterizer.SVGConverterController.class});
